                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div class="md:col-span-1">
                            ...
                            <select name="category_id" required
                                class="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-orange-500 transition outline-none font-bold text-slate-700 cursor-pointer">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" required placeholder="Ex: Installation Chauffe-eau"
                                class="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-orange-500 transition outline-none font-bold text-slate-700">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 text-slate-700 font-bold">
                        <div class="md:col-span-1">
                            ...
                            <input type="text" name="duration" placeholder="Ex: 2 heures"
                                class="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-orange-500 transition outline-none font-bold">
                        </div>

                        <div class="md:col-span-3">
                            <label class="block text-xs font-black text-slate-400 uppercase mb-2 ml-1">Description
                                courte</label>
                            <textarea name="description" rows="1" required placeholder="Décrivez brièvement ce que comprend ce service..."
                                class="w-full p-4 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-orange-500 transition outline-none font-bold"></textarea>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-bold uppercase">
                                    {{ $service->duration ?? 'Temps flexible' }}</p>
                            </div>
                        </div>
                ...
                @empty
                    <div
                        ...
                        <p class="text-slate-400 font-bold uppercase tracking-widest text-xs">Aucune offre de service
                            active.</p>
                    </div>
                @endforelse
            </div>
