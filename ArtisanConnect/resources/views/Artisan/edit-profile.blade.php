        ...
        <div class="p-8">
            <div class="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm p-10 border border-slate-100">
                ...
                <form action="{{ route('artisan.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label class="text-xs text-slate-500 uppercase font-bold mb-3 block tracking-widest">Ma
                                Spécialité</label>
                        ...
                        <div>
                            <label class="text-xs text-slate-500 uppercase font-bold mb-3 block tracking-widest">À
                                propos de moi</label>
