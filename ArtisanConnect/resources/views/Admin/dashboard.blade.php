...
<body class="bg-gray-100 font-sans flex">
    ...
    <aside class="w-64 bg-gray-900 min-h-screen text-gray-300 fixed md:relative z-50">
        ...
        <nav class="p-4 space-y-2">
            <a href="#" class="flex items-center p-3 rounded-lg bg-gray-800 text-white"><i class="fa-solid fa-chart-pie mr-3"></i> Dashboard</a>
            ...
            <a href="categories" class="flex items-center p-3 rounded-lg hover:bg-gray-800 transition"><i class="fa-solid fa-list-check mr-3"></i> Catégories</a>
            ...
            <div class="pt-10 border-t border-gray-800 mt-10">
                <a href="/" class="flex items-center p-3 rounded-lg hover:bg-blue-900 transition text-blue-400"><i class="fa-solid fa-house mr-3"></i> Retour au Site</a>
                <a href="/logout" class="flex items-center p-3 rounded-lg hover:bg-red-900 transition text-red-400 mt-2"><i class="fa-solid fa-power-off mr-3"></i> Déconnexion</a>
            </div>
        </nav>
    </aside>
        ...
        <div class="p-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <button class="text-sm bg-blue-50 text-blue-600 px-4 py-2 rounded-lg font-bold hover:bg-blue-100 transition">Voir tout</button>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr>
                            <td class="p-4 flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold">M</div>
                                <div>
                                    <p class="font-bold text-gray-800 text-sm">Mehdi Alami</p>
                                    <p class="text-xs text-gray-400 italic">mehdi@mail.com</p>
                                </div>
                            </td>
                            <td class="p-4">
                                <span class="px-2 py-1 bg-orange-100 text-orange-600 rounded text-[10px] font-bold uppercase">Artisan</span>
                            </td>
                            <td class="p-4 text-sm text-gray-600">Casablanca</td>
                            <td class="p-4">
                                <span class="flex items-center gap-1 text-green-500 text-xs font-bold"><span class="w-2 h-2 bg-green-500 rounded-full"></span> Vérifié</span>
                            </td>
                            <td class="p-4 text-center">
                                <button class="text-gray-400 hover:text-red-500 transition mr-2"><i class="fa-solid fa-ban"></i></button>
                                <button class="text-gray-400 hover:text-blue-500 transition"><i class="fa-solid fa-pen-to-square"></i></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
