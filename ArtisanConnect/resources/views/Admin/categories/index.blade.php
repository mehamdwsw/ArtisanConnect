...
<body class="bg-gray-100 font-sans flex">
    ...
    <aside class="w-64 bg-gray-900 min-h-screen text-gray-300 fixed md:relative z-50">
        ...
        <nav class="p-4 space-y-2">
            <a href="/admin/dashboard" class="flex items-center p-3 rounded-lg hover:bg-gray-800 transition"><i
            ...
            <a href="/admin/categories" class="flex items-center p-3 rounded-lg bg-gray-800 text-white"><i
            ...
            <div class="pt-10 border-t border-gray-800 mt-10">
                ...
                <a href="{{ route('logout') }}"
                    class="w-full flex items-center p-3 rounded-lg hover:bg-red-900 transition text-red-400 mt-2">
    ...
    <div class="flex-1">
        ...
        <div class="p-8">
            @if (session('success'))
                <div
                    class="mb-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 font-bold rounded shadow-sm">
                    {{ session('success') }}
                </div>
            @endif
