    ...
    <div class="flex min-h-screen">
        <aside class="w-72 bg-white border-r border-slate-200 hidden lg:block shadow-sm">
            ...
            <nav class="mt-4 p-4 space-y-2">
                <a href="#"
                    class="flex items-center py-3 px-4 rounded-xl bg-blue-50 text-blue-700 font-bold transition">
                ...
                <a href="/logout"
                    class="flex items-center py-3 px-4 rounded-xl text-red-400 hover:bg-red-50 transition font-medium">
        ...
        <main class="flex-1">
            ...
            <div class="p-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    ...
                    <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
                        <div
                            class="w-14 h-14 bg-green-50 text-green-600 rounded-2xl flex items-center justify-center text-xl shadow-inner">
                    ...
                    <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
                        <div
                            class="w-14 h-14 bg-orange-50 text-orange-600 rounded-2xl flex items-center justify-center text-xl shadow-inner">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2 space-y-6">
                        <div class="flex justify-between items-center px-2">
                            <h3 class="text-lg font-black text-slate-800 uppercase italic tracking-tighter">Réservations
                                Récentes</h3>
                            <a href="#" class="text-blue-600 text-xs font-bold hover:underline">Voir tout</a>
                        </div>

                        <div
                            class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-md transition-all flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-16 h-16 bg-slate-900 text-white rounded-3xl flex flex-col items-center justify-center">
                                    <span class="text-[8px] font-black uppercase opacity-60">Mai</span>
                                    <span class="text-xl font-black italic">14</span>
                                </div>
                                <div>
                                    <h4 class="font-black text-slate-800 uppercase italic leading-none">Réparation
                                        Plomberie</h4>
                                    <p class="text-xs text-slate-400 mt-1 font-medium italic">Artisan: <span
                                            class="text-blue-600">Ahmed Mansouri</span></p>
                                </div>
                            </div>
                            <div class="flex flex-col items-end">
                                <span
                                    class="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest bg-orange-100 text-orange-600 mb-2">En
                                    attente</span>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="font-black text-slate-800 uppercase italic leading-none">Installation
                                        Électrique</h4>
                                    <p class="text-xs text-slate-400 mt-1 font-medium italic">Artisan: <span
                                            class="text-blue-600">Yassine Amrani</span></p>
                                </div>
                            </div>
                            <div class="flex flex-col items-end">
                                <span
                                    class="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest bg-green-100 text-green-600 mb-2">Terminée</span>
                    ...
                    <div class="space-y-6">
                        <h3 class="text-lg font-black text-slate-800 uppercase italic tracking-tighter px-2">Besoin
                            d'aide ?</h3>
                        <div
                            class="bg-blue-700 rounded-[2.5rem] p-8 text-white shadow-xl shadow-blue-100 relative overflow-hidden group">
                            <div class="relative z-10">
                                <h4 class="text-xl font-black italic uppercase leading-tight mb-2">Trouvez un nouvel
                                    Artisan</h4>
                                <p class="text-blue-100 text-sm font-medium mb-6 leading-relaxed">Parcourez nos
                                    catégories et réservez un service en quelques clics.</p>
                                <a href="/"
                                    class="inline-block bg-white text-blue-700 px-6 py-3 rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-orange-500 hover:text-white transition-all shadow-lg active:scale-95">Explorer
                                    les métiers</a>
                            </div>
                            <i
                                class="fa-solid fa-magnifying-glass absolute -bottom-4 -right-4 text-8xl text-blue-800/50 transform -rotate-12 group-hover:scale-110 transition-transform"></i>
                        </div>

                        <div class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm">
                            <h4 class="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] mb-4">Profil à
                                80%</h4>
                            <div class="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                                <div
                                    class="w-[80%] h-full bg-orange-500 rounded-full shadow-[0_0_10px_rgba(249,115,22,0.4)]">
                                </div>
                            </div>
                            <p class="text-[10px] text-slate-400 mt-3 font-medium italic">Ajoutez un numéro de
                                téléphone pour plus de rapidité.</p>
                        </div>
                    </div>
                </div>
            </div>
